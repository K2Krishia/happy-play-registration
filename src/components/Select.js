      ...
      >
        <span
          className={cn(
            ...
            'absolute text-[12px] text-dark-400 font-light leading-none text-inherit'
          )}
        >
          {label}
        ...
        {icon && icon}
        <select
          className="bg-transparent text-dark-400 pl-2 pr-4 w-full outline-none"
          {...props}
        />
      </div>
    )
